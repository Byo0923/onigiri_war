...
MyPose way_point[] = {
    { -0.74 - Diff_Start_X,  0.00,  0.00, false, 2.0},
    { -0.60 - Diff_Start_X,  0.00,  0.00, false, 2.0},
    { -0.60 - Diff_Start_X,  0.00,  0.80, false, 2.0},
    {  0.00 - Diff_Start_X,  0.80,  0.80, false, 2.0},
    {  0.00 - Diff_Start_X,  0.80,  0.00, false, 5.0},
    {  0.10 - Diff_Start_X,  0.80,  0.00, false, 2.0},
    {  0.10 - Diff_Start_X,  0.80,  0.20, false, 2.0},
    {  0.10 - Diff_Start_X,  0.80,  0.00, false, 2.0},
    {  0.10 - Diff_Start_X,  0.80, -0.50, false, 2.0},
    {  0.10 - Diff_Start_X,  0.80, -1.50, false, 2.0},
    {  0.00 - Diff_Start_X,  0.60, -1.50, false, 2.0},
    {  0.00 - Diff_Start_X,  0.60, -0.80, false, 2.0},
    {  0.00 - Diff_Start_X,  0.60, -2.20, false, 2.0},
    { -0.20 - Diff_Start_X,  0.74, -1.80, false, 2.0},
    { -0.20 - Diff_Start_X,  0.74, -2.60, false, 2.0},
    { -0.74 - Diff_Start_X,  0.00, -2.60, false, 2.0},
    { -0.74 - Diff_Start_X,  0.00, -3.60, false, 2.0},
    { -0.74 - Diff_Start_X,  0.00, -2.60, false, 2.0},
    { -1.30 - Diff_Start_X, -0.74, -2.60, false, 2.0},
    { -1.30 - Diff_Start_X, -0.74,  0.10, false, 2.0},
    { -1.30 - Diff_Start_X, -0.74, -1.80, false, 2.0},
    { -1.30 - Diff_Start_X,  0.74, -1.80, false, 2.0},
    { -1.30 - Diff_Start_X,  0.74,  0.00, false, 2.0},
